...
class BodyTest {
    ...
    private final String someOtherMessage = "{" +
             "\"objectId\":\"users9.avro\"\n" +
             "}";

    private final String someWrongFormatMessage = "}{";
    ...
    @Test
    public void testWrongJsonMessage() throws JsonProcessingException {
        final Body body = objectMapper.readValue(someOtherMessage, Body.class);
    ...
    public void testWrongJsonFormat() {
        assertThrows(JsonProcessingException.class, () ->
                objectMapper.readValue(someWrongFormatMessage, Body.class));
    }
